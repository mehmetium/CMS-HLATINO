...
<html>
    <head>
        ...
        <title><?php echo name; ?> &raquo; Noticias</title>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-4">
			<?php include_once 'includes/add-list-news.php'; ?>
<br>

		</div>	
		
		<div class="col-xs-12 col-sm-8">
		    <?php include_once 'includes/add-new.php'; ?>
			<?php include_once 'includes/add-comments-news.php'; ?>
		</div>
	</div>
</div>
...
<?php if(isset($_SESSION['comment_error'])) { unset($_SESSION['comment_error']); } $_SESSION['id_new'] = $id; unset($page); ?>
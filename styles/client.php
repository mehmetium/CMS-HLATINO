...
<link rel="stylesheet" type="text/css" href="http://hlatino.net/styles/clientapp.css?334">
		<script src="<?php echo www; ?>/clientjs/client.js" type="text/javascript"></script>
<link rel="stylesheet" href="http://hlatino.net/styles/client-icons.css" type="text/css" />
<link rel="stylesheet" href="http://hlatino.net/styles/boxes.css" type="text/css" />
...
<button ngsf-toggle-fullscreen="" class="client__fullscreen" onClick="window.moveTo(0,0);window.resizeTo(screen.availWidth, screen.availHeight);"><b><i class="fa fa-snowflake-o " aria-hidden="true"></i> Descongelar</b></button>
</div>
...
<div id="harticoradio" class="menu_hotel">
...
<img src="//images.hartico.com/nuevaweb/images/cerrar.png">
	...
	<script>
		...
		<script>if(!FlashDetect.installed){window.location.href = "<?php echo www; ?>/noflash";}</script>
               <script type="text/javascript" src="http://hlatino.net/styles/js/radioApp.js?2"></script>	</body>

...
<title>Registro</title>
       <meta name="description" content="tu descripcion">
...
<body>
<div id="fondo-imag">
    <img src="http://i54.tinypic.com/24g105f.png" alt="una imagen" /></div>
                ...
                <div class="panel-body">
					<form action="<?php echo www; ?>/app/submits/register_submit.php" method="POST">
                        <center><div class="form-group">
                            <input type="text" class="form-control" name="reg_usuario" placeholder="Nombre de usuario" value="<?php echo $_GET['reg_usuario']; ?>" maxlength="15">
                        </div>
						<div class="form-group">
                            <input type="email" class="form-control" name="reg_mail" placeholder="Correo electronico   (SERVIRA PARA RECUPERAR TU CONTRASE&Ntilde;A)" value="<?php echo $_GET['reg_mail']; ?>">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" name="reg_contrasena" placeholder="Contrase&ntilde;a" value="<?php echo $_GET['reg_contrasena']; ?>">
                        </div>
						<div class="form-group">
                            <input type="password" class="form-control" name="reg_rcontrasena" placeholder="Repite la contrase&ntilde;a" value="<?php echo $_GET['reg_rcontrasena']; ?>">
                        </div>
						<div class="form-group">
						    						</div>	
											
					    <input type="submit" class="btn btn-primary" value="REGISTRARME" />  </center>               </div>
		    </div>
